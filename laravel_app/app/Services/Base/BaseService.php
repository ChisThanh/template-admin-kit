...
abstract class BaseService
{
    ...
    {
        // $this->client = new Client('meilisearch:7700', 'masterKey');
    }
    ...
    // public function searchMelisearch($inputs)
    // {
    //     $term = isset($inputs['term']) ? $inputs['term'] : '';
    //     $page = isset($inputs['page']) ? $inputs['page'] : 1;
    //     $limit = isset($inputs['limit']) ? $inputs['limit'] : 30;
    ...
    //     $data = $this->client->index($this->getIndexName())->search(
    //         "\"" . $term . "\"",
    //         [
    ...
    //         ]
    //     )->toArray();
    //     //        $documents = $this->client->index($this->getIndexName())->getDocuments(
    //     //            (new DocumentsQuery())->setFilter($inputs['filter'])
    //     //        )->toArray();
    //     return [
    //         'code' => '200',
    //         'data' => [
    //             'data' => $data['hits'],
    //             'total' => $data['hitsCount']
    //         ]
    //     ];
    // }
